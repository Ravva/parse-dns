...
async function gotoAndReport(context: BrowserContext, url: string, prefix: string): Promise<DebugResult> {
...
async function main() {
  ...
  const base = await gotoAndReport(context, "https://www.dns-shop.ru/?cityPath=msk", "debug_dns_base");
